...
Do
   ...
   Elseif Zezwolenie = 0 Then
      ...
      If Aldl_recv(2) = &HF4 And Suma_kontrolna = 0 Then    'And Aldl_recv(66) = Suma_kontrolna Then
         ...
         #endif
         Went_silnika = Aldl_recv(17).0
         Went_skrzyni = Aldl_recv(17).1
      End If
      Zezwolenie = 11
...
' temperatura   = 130                 = -50    (180 - 130) *-1
   ...
   Text11 = Str(temperatura_skrzyni)
   Text11 = Format(text11 , "000")

   Call Lcd_text(text11 , 1 , 50 , 2)

   If Went_silnika = 1 Then

      Text11 = Str(temperatura_silnika) + "*"
      Text11 = Format(text11 , "0000")
      Call Lcd_text(text11 , 100 , 55 , 1)
